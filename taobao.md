...
クレジットカードは商品代金に加えて、手数料が3%上乗せされます。アリペイは手数料なしで使えますが、基本的に中国に銀行口座を保有していないと使えないので諦めましょう。最近、ツーリスト用のアリペイ口座に国際クレジットカードからチャージできるようになりましたが、タオバオで使えるかどうかはまだ検証していません。
...
<img width="580" alt="商品のお気に入り登録" src="./images/google_translate.jpg">
