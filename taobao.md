...
- [タオバオ超ざっくり解説](#タオバオ超ざっくり解説)
    - [タオバオとは](#タオバオとは)
    - [タオバオ最強伝説](#タオバオ最強伝説)
    - [タオバオで購入するメリット](#タオバオで購入するメリット)
    - [タオバオで購入するデメリット](#タオバオで購入するデメリット)
    - [天猫（T-mall）との違いは？](#天猫t-mallとの違いは)
- [タオバオを覗いてみよう](#タオバオを覗いてみよう)
    - [シナリオ](#シナリオ)
    ...
    - [商品の検索方法](#商品の検索方法)
    - [価格表記](#価格表記)
- [気に入った店舗や商品が見つかったら](#気に入った店舗や商品が見つかったら)
    - [商品の詳細をみる](#商品の詳細をみる)
- [いよいよ買ってみよう](#いよいよ買ってみよう)
    - [商品説明に目を通そう](#商品説明に目を通そう)
    - [買い物かごから買う方法](#買い物かごから買う方法)
    - [どうやって支払う？](#どうやって支払う)
    - [転送倉庫への配送状況を確認しよう！](#転送倉庫への配送状況を確認しよう)
    - [転送倉庫から日本へ配送を指示しよう！](#転送倉庫から日本へ配送を指示しよう)
    - [日本への配送状況を確認しよう！](#日本への配送状況を確認しよう)
    - [配送料は？](#配送料は)
    - [輸入にかかる税金や手数料は？](#輸入にかかる税金や手数料は)
- [トラブルシューティング](#トラブルシューティング)
    - [間違えて発注してしまった！](#間違えて発注してしまった)
    - [店からメッセージが来た！](#店からメッセージが来た)
- [便利機能いろいろ](#便利機能いろいろ)
    - [お気に入り機能](#お気に入り機能)
    - [店に質問してみよう](#店に質問してみよう)
    - [クーポンで安く買おう](#クーポンで安く買おう)
    - [商品を評価しよう](#商品を評価しよう)
    - [フレンド機能](#フレンド機能)
...
# 1. タオバオ超ざっくり解説
<a id="markdown-タオバオ超ざっくり解説" name="タオバオ超ざっくり解説"></a>

## 1.1. タオバオとは
<a id="markdown-タオバオとは" name="タオバオとは"></a>
- 中国版Amazonもしくは楽天　の　**超高機能なやつ**

## 1.2. タオバオ最強伝説
<a id="markdown-タオバオ最強伝説" name="タオバオ最強伝説"></a>
- 最強の商品数（2017年）
...
## 1.3. タオバオで購入するメリット
<a id="markdown-タオバオで購入するメリット" name="タオバオで購入するメリット"></a>
- 中国の商品が手に入る　　　→　欲しい物が手に入る
- 商品の数が膨大に存在する　→　欲しい物が手に入る
- 同様の商品が日本より安い　→　経済合理性が高い（ただし、税金と通関手数料は別途かかる）

## 1.4. タオバオで購入するデメリット
<a id="markdown-タオバオで購入するデメリット" name="タオバオで購入するデメリット"></a>
- 偽物があるかもしれない　→　トラブったときにだるい
- 品質が悪いかもしれない　→　金額が大きいとエモい
- 重かったり購入金額が小さいかったりすると配送料負けするかもしれない　→　経済合理性が低い

## 1.5. 天猫（T-mall）との違いは？
<a id="markdown-天猫t-mallとの違いは" name="天猫t-mallとの違いは"></a>
- 天猫（T-mall）　 　→　ららぽーと
- タオバオ　　　　　→　ドン・キホーテ

# 2. タオバオを覗いてみよう
<a id="markdown-タオバオを覗いてみよう" name="タオバオを覗いてみよう"></a>

## 2.1. シナリオ
<a id="markdown-シナリオ" name="シナリオ"></a>
...
## 2.2. アプリのダウンロード
<a id="markdown-アプリのダウンロード" name="アプリのダウンロード"></a>
...
## 2.3. アカウント開設方法
<a id="markdown-アカウント開設方法" name="アカウント開設方法"></a>
...
## 2.4. ログイン方法
<a id="markdown-ログイン方法" name="ログイン方法"></a>
...
## 2.5. 商品の検索方法
<a id="markdown-商品の検索方法" name="商品の検索方法"></a>
...
## 2.6. 価格表記
<a id="markdown-価格表記" name="価格表記"></a>
...
# 3. 気に入った店舗や商品が見つかったら
<a id="markdown-気に入った店舗や商品が見つかったら" name="気に入った店舗や商品が見つかったら"></a>

## 3.1. 商品の詳細をみる
<a id="markdown-商品の詳細をみる" name="商品の詳細をみる"></a>
...
# 4. いよいよ買ってみよう
<a id="markdown-いよいよ買ってみよう" name="いよいよ買ってみよう"></a>

## 4.1. 商品説明に目を通そう
<a id="markdown-商品説明に目を通そう" name="商品説明に目を通そう"></a>
...
## 4.2. 買い物かごから買う方法
<a id="markdown-買い物かごから買う方法" name="買い物かごから買う方法"></a>
...
## 4.3. どうやって支払う？
<a id="markdown-どうやって支払う" name="どうやって支払う"></a>
...
## 4.4. 転送倉庫への配送状況を確認しよう！
<a id="markdown-転送倉庫への配送状況を確認しよう" name="転送倉庫への配送状況を確認しよう"></a>
...
## 4.5. 転送倉庫から日本へ配送を指示しよう！
<a id="markdown-転送倉庫から日本へ配送を指示しよう" name="転送倉庫から日本へ配送を指示しよう"></a>
...
## 4.6. 日本への配送状況を確認しよう！
<a id="markdown-日本への配送状況を確認しよう" name="日本への配送状況を確認しよう"></a>

## 4.7. 配送料は？
<a id="markdown-配送料は" name="配送料は"></a>
...
## 4.8. 輸入にかかる税金や手数料は？
<a id="markdown-輸入にかかる税金や手数料は" name="輸入にかかる税金や手数料は"></a>
...
# 5. トラブルシューティング
<a id="markdown-トラブルシューティング" name="トラブルシューティング"></a>

## 5.1. 間違えて発注してしまった！
<a id="markdown-間違えて発注してしまった" name="間違えて発注してしまった"></a>

## 5.2. 店からメッセージが来た！
<a id="markdown-店からメッセージが来た" name="店からメッセージが来た"></a>

# 6. 便利機能いろいろ
<a id="markdown-便利機能いろいろ" name="便利機能いろいろ"></a>

## 6.1. お気に入り機能
<a id="markdown-お気に入り機能" name="お気に入り機能"></a>
- 商品をお気に入りに登録する
...
## 6.2. 店に質問してみよう
<a id="markdown-店に質問してみよう" name="店に質問してみよう"></a>
...
## 6.3. クーポンで安く買おう
<a id="markdown-クーポンで安く買おう" name="クーポンで安く買おう"></a>

## 6.4. 商品を評価しよう
<a id="markdown-商品を評価しよう" name="商品を評価しよう"></a>

## 6.5. フレンド機能
<a id="markdown-フレンド機能" name="フレンド機能"></a>
中国人の友人「意味ない」
